// https://github.com/Paul-Riggott/PS-Scripts/blob/master/Calendar.jsx
// 2024-01-10 닫기 기능 추가, 테스트 수정 - 강태희
#target Photoshop
app.bringToFront();
main();
function main() {
    ...
    try {
        ...
        win.title = win.g1.add('statictext', undefined, '레이어 이름 에디터');
        win.title.alignment = "fill";
        var g = win.title.graphics;
        g.font = ScriptUI.newFont("Malgun Gothic", "BOLD", 22);
        ...
        win.g500.st1 = win.g500.add('statictext', undefined, '삽입내용');
        ...
        win.g510.st1 = win.g510.add('statictext', undefined, '삽입위치');
        ...
        win.g620.cb2 = win.g620.add('checkbox', undefined, 'Case Insensitive 대소문자');
        ...
        win.g1000.bu1 = win.g1000.add('button', undefined, '처리');
        win.g1000.bu1.preferredSize = [150, 30];
        win.g1000.bu2 = win.g1000.add('button', undefined, '취소');
